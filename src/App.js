...
function App() {
  const [inputText, setInputText] = useState('print("Made with 💓 by CodewithAkshay")');
  ...
  return (
    <>
      <div className='flex flex-row justify-between p-5 text-3xl'>
        ...
        <a href="https://github.com/akshayram1/ide" className='ml-auto gap-1 text-xl bg-black text-white px-2 py-1 rounded flex justify-end items-center' target='_blank' rel='noreferrer'>
